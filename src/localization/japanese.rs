...
pub(super) const STRINGS: Strings = Strings {
    ...
    settings: "設定",
    placement: "配置",
    placement_taskbar: "タスクバー",
    placement_floating: "フローティング",
    placement_tray_only: "トレイのみ",
    ...
    hour_suffix: "時間",
    minute_suffix: "分",
    token_expired_title: "Claude 使用状況の更新を一時停止中",
    token_expired_body: "Claude Code を開いてメッセージを送信してください。Claude に求められた場合は、再度サインインしてください。モニターは自動的に再接続します。",
    last_updated: "最終更新",
