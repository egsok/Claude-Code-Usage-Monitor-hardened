...
pub(super) const STRINGS: Strings = Strings {
    ...
    settings: "Paramètres",
    placement: "Position",
    placement_taskbar: "Barre des tâches",
    placement_floating: "Flottant",
    placement_tray_only: "Zone de notification uniquement",
    ...
    hour_suffix: "h",
    minute_suffix: "m",
    token_expired_title: "Suivi Claude en pause",
    token_expired_body: "Ouvrez Claude Code et envoyez un message. Si Claude le demande, reconnectez-vous. Le moniteur se reconnectera automatiquement.",
...
pub const MONITOR_STRINGS: super::MonitorStrings = super::MonitorStrings {
    ...
    no_taskbar: "sans barre des tâches",
