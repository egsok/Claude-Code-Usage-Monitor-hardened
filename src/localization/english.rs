...
pub(super) const STRINGS: Strings = Strings {
    ...
    settings: "Settings",
    placement: "Placement",
    placement_taskbar: "Taskbar",
    placement_floating: "Floating",
    placement_tray_only: "Tray only",
    ...
    hour_suffix: "h",
    minute_suffix: "m",
    token_expired_title: "Claude usage paused",
    token_expired_body: "Open Claude Code and send a message. If Claude asks, sign in again. This monitor will reconnect automatically.",
...
pub const MONITOR_STRINGS: super::MonitorStrings = super::MonitorStrings {
    ...
    no_taskbar: "no taskbar",
    reset_all: "Reset all widget positions",
};
