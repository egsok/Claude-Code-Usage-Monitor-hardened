...
pub(super) const STRINGS: Strings = Strings {
    ...
    placement_taskbar: "Barra de tarefas",
    placement_floating: "Flutuante",
    placement_tray_only: "Somente bandeja",
    ...
    minute_suffix: "m",
    second_suffix: "s",
    token_expired_title: "Uso do Claude pausado",
    token_expired_body: "Abra o Claude Code e envie uma mensagem. Se o Claude solicitar, entre novamente. O monitor se reconectará automaticamente.",
