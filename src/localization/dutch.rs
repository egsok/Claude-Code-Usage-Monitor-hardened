...
pub(super) const STRINGS: Strings = Strings {
    ...
    placement: "Plaatsing",
    placement_taskbar: "Taakbalk",
    placement_floating: "Zwevend",
    placement_tray_only: "Alleen systeemvak",
    ...
    hour_suffix: "u",
    minute_suffix: "m",
    token_expired_title: "Claude-gebruik gepauzeerd",
    token_expired_body: "Open Claude Code en stuur een bericht. Meld je opnieuw aan als Claude daarom vraagt. Deze monitor maakt automatisch opnieuw verbinding.",
...
pub const MONITOR_STRINGS: super::MonitorStrings = super::MonitorStrings {
    monitors: "Beeldschermen",
    primary: "primair",
    disconnected: "niet aangesloten",
    no_taskbar: "geen taakbalk",
    reset_all: "Alle widgetposities herstellen",
};
