...
pub(super) const STRINGS: Strings = Strings {
    ...
    placement_taskbar: "Панель задач",
    placement_floating: "Плавающее окно",
    placement_tray_only: "Только значки в трее",
    ...
    minute_suffix: "м",
    second_suffix: "с",
    token_expired_title: "Данные Claude временно не обновляются",
    token_expired_body: "Откройте Claude Code и отправьте сообщение. Если Claude попросит, войдите снова. Монитор подключится автоматически.",
