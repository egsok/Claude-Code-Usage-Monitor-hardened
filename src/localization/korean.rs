...
pub(super) const STRINGS: Strings = Strings {
    ...
    settings: "설정",
    placement: "배치",
    placement_taskbar: "작업 표시줄",
    placement_floating: "플로팅",
    placement_tray_only: "트레이만",
    ...
    hour_suffix: "시간",
    minute_suffix: "분",
    token_expired_title: "Claude 사용량 업데이트 일시 중지",
    token_expired_body: "Claude Code를 열고 메시지를 보내세요. Claude가 요청하면 다시 로그인하세요. 모니터가 자동으로 다시 연결됩니다.",
